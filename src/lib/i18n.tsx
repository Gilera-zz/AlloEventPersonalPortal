...
const dict = {
  ...
  forgot_password: { sv: "Glömt lösenord?", en: "Forgot password?" },
  forgot_password_title: { sv: "Återställ lösenord", en: "Reset password" },
  forgot_password_desc: { sv: "Ange din e-postadress så skickar vi en återställningslänk.", en: "Enter your email and we'll send you a reset link." },
  send_reset_link: { sv: "Skicka återställningslänk", en: "Send reset link" },
  reset_link_sent: { sv: "En återställningslänk har skickats till din e-post.", en: "A reset link has been sent to your email." },
  back_to_login: { sv: "Tillbaka till inloggning", en: "Back to login" },
  reset_password_title: { sv: "Välj nytt lösenord", en: "Choose new password" },
  reset_password_desc: { sv: "Ange ditt nya lösenord nedan.", en: "Enter your new password below." },
  new_password: { sv: "Nytt lösenord", en: "New password" },
  confirm_password: { sv: "Bekräfta nytt lösenord", en: "Confirm new password" },
  save_new_password: { sv: "Spara nytt lösenord", en: "Save new password" },
  password_updated: { sv: "Lösenordet har uppdaterats!", en: "Password updated!" },
  passwords_no_match: { sv: "Lösenorden matchar inte.", en: "Passwords do not match." },
  password_too_short: { sv: "Lösenordet måste vara minst 6 tecken.", en: "Password must be at least 6 characters." },
  reset_token_missing: { sv: "Ogiltig eller utgången återställningslänk. Begär en ny.", en: "Invalid or expired reset link. Please request a new one." },
